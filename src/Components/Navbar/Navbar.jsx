  ...
  return (
      <div className='navbar'>
          ...
          <ul className="nav-menu">
            ...
            <Link className={activeLink === 'experience' ? 'active' : ''} to="experience" spy={true} smooth={true} duration={200} offset={+10} onSetActive={() => setActiveLink('experience')}>Experience</Link>
            <Link className={activeLink === 'education' ? 'active' : ''} to="education" spy={true} smooth={true} duration={200} offset={-100} onSetActive={() => setActiveLink('education')}>Education</Link>
